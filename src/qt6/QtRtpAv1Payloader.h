...
///
/// \file QtRtpAv1Payloader.h
///

#ifndef QT6_QTRTPAV1PAYLOADER_H_
#define QT6_QTRTPAV1PAYLOADER_H_
...
class QtRtpAv1Payloader : public QtRtpPayloader {
  Q_OBJECT
 ...
 public:
  ...
  /// \param parent
  ///
  explicit QtRtpAv1Payloader(QObject *parent = nullptr);

  ///
  /// \brief Destroy the Qt Rtp H 2 6 4 Payloader object
  ///
  ///
  ~QtRtpAv1Payloader() final;
 ...
 private:
  ...
  ::mediax::rtp::av1::gst::RtpAv1GstPayloader payloader_;
};

}  // namespace mediax::qt6

#endif  // QT6_QTRTPAV1PAYLOADER_H_
