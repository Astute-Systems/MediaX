...
#ifndef H265_GST_VAAPI_RTP_av1_DEPAYLOADER_H_
#define H265_GST_VAAPI_RTP_av1_DEPAYLOADER_H_
...
class RtpAv1GstDepayloader : public mediax::rtp::RtpDepayloader {
 public:
  ///
  /// \brief Construct a new Rtpvraw Depayloader object
  ///
  ///
  RtpAv1GstDepayloader();

  ///
  /// \brief Destroy the Rtpvraw Depayloader object
  ///
  ///
  ~RtpAv1GstDepayloader() final;
  ...
  ///
  RtpAv1GstDepayloader &operator=(const RtpAv1GstDepayloader &other);
  ...
  /// \param other
  ///
  RtpAv1GstDepayloader(RtpAv1GstDepayloader &&other) = delete;
...
#endif  // H265_GST_VAAPI_RTP_av1_DEPAYLOADER_H_
