...
///
/// \file QtRtpAv1Depayloader.cc
///

#include "qt6/QtRtpAv1Depayloader.h"

#include <algorithm>

namespace mediax::qt6 {

QtRtpAv1Depayloader::QtRtpAv1Depayloader(QObject *parent) : QtRtpDepayloader(parent) {}

void QtRtpAv1Depayloader::setStreamInfo(const mediax::rtp::StreamInformation &stream_information) {
...
Q_INVOKABLE bool QtRtpAv1Depayloader::open() { return m_depayloader.Open(); }

Q_INVOKABLE void QtRtpAv1Depayloader::start() { m_depayloader.Start(); }

Q_INVOKABLE void QtRtpAv1Depayloader::stop() { m_depayloader.Stop(); }

Q_INVOKABLE void QtRtpAv1Depayloader::close() { m_depayloader.Close(); }

Q_INVOKABLE bool QtRtpAv1Depayloader::receive(QByteArray *frame, int timeout) {
...
Q_INVOKABLE QVector<quint8> QtRtpAv1Depayloader::getBuffer() {
...
Q_INVOKABLE mediax::rtp::StreamState QtRtpAv1Depayloader::getState() const { return m_depayloader.GetState(); }
