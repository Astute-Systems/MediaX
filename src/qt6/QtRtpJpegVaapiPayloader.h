...
///
/// \file QtRtpJpegVaapiPayloader.h
///

#ifndef QT6_QTRTPJPEGVAAPIPAYLOADER_H_
#define QT6_QTRTPJPEGVAAPIPAYLOADER_H_
...
class QtRtpJpegVaapiPayloader : public QtRtpPayloader {
  Q_OBJECT
 ...
 public:
  ...
  /// \param parent
  ///
  explicit QtRtpJpegVaapiPayloader(QObject *parent = nullptr);
...
#endif  // QT6_QTRTPJPEGVAAPIPAYLOADER_H_
