...
///
/// \file QtRtpJpegDepayloader.h
///

#ifndef QT6_QTRTPJPEGDEPAYLOADER_H_
#define QT6_QTRTPJPEGDEPAYLOADER_H_
...
class QtRtpJpegDepayloader : public QtRtpDepayloader {
 public:
  ///
  ...
  /// \param parent
  ///
  explicit QtRtpJpegDepayloader(QObject *parent = nullptr);
...
#endif  // QT6_QTRTPJPEGDEPAYLOADER_H_
