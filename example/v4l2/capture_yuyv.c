 ...
 * capturing 16-bit YUYV and/or 8-bit Gray-scale image with Sensoray Model 812
 * /811/911/614/314/611/311, and saving the images into bitmap PPM/PGM files,
 * using saa7134 (for Model 811/911/614/314) driver or bttv (for Model 611/311)
 * driver or TW6869 (for Model 812) driver, complying with V4L2 API.
 *
 ...
 *              Spt. 13, 2010   Charlie X. Liu	added capturing in V4L2_PIX_FMT_YUYV mode,
 *                                              and then converting YUYV to RGB888 format,
 *              Apr. 25, 2012   Charlie X. Liu	tested for Model 812; added and adjusted
 *                                              comments
 */
