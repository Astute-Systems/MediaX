...
#ifndef H264_GST_OMX_RTP_H264_DEPAYLOADER_H_
#define H264_GST_OMX_RTP_H264_DEPAYLOADER_H_
...
class RtpH264GstOmxDepayloader : public mediax::rtp::RtpDepayloader {
 public:
  ///
  ...
  ///
  RtpH264GstOmxDepayloader &operator=(const RtpH264GstOmxDepayloader &other);
  ...
  /// \param other
  ///
  RtpH264GstOmxDepayloader(RtpH264GstOmxDepayloader &&other) = delete;
