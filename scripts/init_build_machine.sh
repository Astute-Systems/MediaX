...
apt-get --no-install-recommends -y install libswscale-dev libgflags-dev libgtkmm-3.0-dev cmake g++ libgtest-dev libva-dev libdrm-dev libx11-dev libxext-dev libxfixes-dev libvdpau-dev cppcheck cpplint libunwind-dev libgoogle-glog-dev gcovr lcov swig qt6-base-dev
