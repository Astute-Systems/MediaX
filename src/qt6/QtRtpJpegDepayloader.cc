...
///
/// \file QtRtpJpegDepayloader.cc
///

#include "qt6/QtRtpJpegDepayloader.h"

#include <algorithm>

namespace mediax::qt6 {

QtRtpJpegDepayloader::QtRtpJpegDepayloader(QObject *parent) : QtRtpDepayloader(parent) {}

void QtRtpJpegDepayloader::setStreamInfo(const mediax::rtp::StreamInformation &stream_information) {
...
Q_INVOKABLE bool QtRtpJpegDepayloader::open() { return m_depayloader.Open(); }

Q_INVOKABLE void QtRtpJpegDepayloader::start() { m_depayloader.Start(); }

Q_INVOKABLE void QtRtpJpegDepayloader::stop() { m_depayloader.Stop(); }

Q_INVOKABLE void QtRtpJpegDepayloader::close() { m_depayloader.Close(); }

Q_INVOKABLE bool QtRtpJpegDepayloader::receive(QByteArray *frame, int timeout) {
...
Q_INVOKABLE QVector<quint8> QtRtpJpegDepayloader::getBuffer() {
...
Q_INVOKABLE mediax::rtp::StreamState QtRtpJpegDepayloader::getState() const { return m_depayloader.GetState(); }
